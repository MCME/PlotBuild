            ...
            switch(block.getType()) {
                ...
                case SKULL:
                    ...
                    if(((Skull)block.getState()).getSkullType().equals(SkullType.PLAYER)) {
                        ItemStack headItem = HeadUtil.pickCustomHead((Skull)block.getState());
                        blockData.put("headItem", headItem);
                    }
                    break;
            }
                ...
                if(updateBlocks) {
                    ...
                    case SKULL:
                        ...
                        if(((Skull)state).getSkullType().equals(SkullType.PLAYER)) {
                            HeadUtil.placeCustomHead(state.getBlock(), (ItemStack)data.get("headItem"));
                        }
                        state = state.getBlock().getState();
